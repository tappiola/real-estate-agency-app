...
const getProperties = async (args, req) => {
  const { adType, page, cityId, propertyTypeId, minPrice, maxPrice } = args;
  ...
  const condition = {typeId, ...cityCondition, ...propertyTypeCondition, ...minPriceCondition, ...maxPriceCondition};
